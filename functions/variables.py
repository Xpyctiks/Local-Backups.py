...
PID_FILE = os.path.join("/tmp/","local-backups.pid")
LISTENER_PID_FILE = os.path.join("/tmp/","local-backups-listener.pid")
...
DAILY_FOLDER = WEEKLY_FOLDER = CURR_FOLDER_NAME = USER = GROUP = HOSTNAME = REMOTE_REPORTS_KEY = ""
